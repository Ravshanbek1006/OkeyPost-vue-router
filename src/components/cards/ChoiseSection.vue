<template>
    <section class="container vibor my-5 py-5 text-lg-start text-md-center text-sm-center">
    <h3 class=" col-lg-6 ">120 000 довольных клиентов в России уже сделали свой выбор</h3>
    <p class="col-lg-5 ">За последний год десятки тысяч наших клиентов заказали товары из Англии и оставили 19 633
      отзыва
    </p>
    <div class="row my-5">
    ...
    <div class="my-5 py-6">
      <h3 class="py-4">Отзывы и цитаты блогеров:</h3>
        ...
        <div class="col-lg-6">
          <div class="row bloke">
            ...
            <div class="col-7  p-3 d-flex flex-column justify-content-between">
              ...
              <div class="data">
                <p> <b>дата:</b> 16 новамбер 2021</p>
                <p> <b>город:</b> Санкт-Петербу́рг </p>
              </div>
            </div>
          </div>
        </div>
