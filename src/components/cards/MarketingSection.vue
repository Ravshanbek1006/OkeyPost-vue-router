<template>
   <section class="container marketing py-5 my-5  text-lg-start text-md-center text-sm-center">
    <h3 class="col-lg-6 ">4 простых шага для ваших покупок в Великобритании </h3>
    ...
    <p class=" mt-3">Не хотите разбираться самостоятельно, наши мастера шопинга с радостью купят все товары за вас.</p>
    <div class="m-box"><button class="btn-okey">Быстрая покупка</button></div>
  </section>
</template>
