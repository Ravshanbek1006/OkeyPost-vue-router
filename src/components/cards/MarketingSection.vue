<template>
   <section class="container marketing py-5 my-5">
    <h3 class="col-6">4 простых шага для ваших покупок в Великобритании </h3>
   ...
   <div class="w-50 mt-3" >
    ...
    <button class="btn-okey my-2">Быстрая покупка</button>
  </section>
</template>
